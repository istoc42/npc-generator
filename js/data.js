...
const barovianNamesMale = ['Alek', 'Andrej', 'Anton', 'Balthazar', 'Bogan', 'Boris', 'Dargos', 'Darzin', 'Dragomir', 'Emeric', 'Falkon', 'Frederich', 'Franz', 'Gargosh', 'Gorek', 'Grygori', 'Hans', 'Harkus', 'Ivan', 'Jirko', 'Kobal', 'Korga', 'Krystofor', 'Lazlo', 'Livius', 'Marek', 'Miroslav', 'Nikolaj', 'Nimir', 'Oleg', 'Radovan', 'Radu', 'Seraz', 'Sergei', 'Stefan', 'Tural', 'Valentin', 'Vasily', 'Vladislav', 'Waltar', 'Yesper', 'Zsolt']

const barovianNamesFemale = ['Alana', 'Clavdia', 'Danya', 'Dezdrelda', 'Diavola', 'Dorina', 'Drasha', 'Drilvia', 'Elisabeta', 'Fatima', 'Grilsha', 'Isabella', 'Ivana', 'Jarzinka', 'Kala', 'Katerina', 'Kereza', 'Korina', 'Lavinia', 'Magda', 'Marta', 'Mathilda', 'Minodora', 'Mirabel', 'Miruna', 'Nimira', 'Nyanka', 'Olivenka', 'Ruxandra', 'Sorina', 'Tereska', 'Valentina', 'Vasha', 'Victoria', 'Wensenci', 'Zondra']

const barovianNamesAll = barovianNamesMale.concat(barovianNamesFemale)
// Concat arrays for random buttons ---------------------------------------------------------------------

const randomArr = [createBarovian, createDragonborn, createDwarf, createElf, createHalfling, createHalfOrc, createHuman, createTiefling]
const randomArrMale = [createBarovianMale, createDragonbornMale, createDwarfMale, createElfMale, createHalflingMale, createHalfOrcMale, createHumanMale, createTieflingMale]
const randomArrFemale = [createBarovianFemale, createDragonbornFemale, createDwarfFemale, createElfFemale, createHalflingFemale, createHalfOrcFemale, createHumanFemale, createTieflingFemale]
